...
<div class="col-md-5 col-md-offset-3">
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title">Tambah Anggota Keluarga</h3>
        </div>
            ...
            <div class="box-body">
                ...
                <div class="form-group {{ $errors->has('nik') ? 'has-error' :'' }}">
                    ...
                    <div class="col-sm-10">
                    <input name="nik" class="form-control" placeholder=" Nomor Induk Kependudukan (NIK) ">{{old('nik')}}
                    @if ($errors->has('nik'))
                        <p class="help-block">
                            {{ $errors->first('nik') }}
                        </p>
                ...
                <div class="form-group {{ $errors->has('nama') ? 'has-error' :'' }}">
                    ...
                    <div class="col-sm-10">
                    <input name="nama" class="form-control" placeholder="Nama Lengkap ">{{old('nama')}}
                    @if ($errors->has('nama'))
                        <p class="help-block">
                            {{ $errors->first('nama') }}
                        </p>
